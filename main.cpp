...
void RenderUI() {
    ...
    //STYLE 1
    // SetNextWindowSize(ImVec2(350,1000));
    // SetNextWindowPos(ImVec2(1570,0));
    // //MAIN CONTROLS
    // if (Begin("Controls", NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize))
    // {
    //     //OBJEK
    //     middletext("Objek");
    //     SetCursorPos(ImVec2(35,70));
    ...
    //     SetCursorPosY(200);
    //     middletext("Warna");
    //     SetCursorPos(ImVec2(60,230));
    //     ColorEdit4("Warna Objek", (float*)&defaultObjColor, ImGuiColorEditFlags_NoLabel | ImGuiColorEditFlags_NoAlpha);
        
    //     //ROTASI
    //     SetCursorPosY(270);
    //     middletext("Rotasi");
    //     SetCursorPos(ImVec2(40,300));
    //     SetCursorPos(ImVec2(100,300));
    ...
    //     SetCursorPos(ImVec2(50,340));
    //     SliderFloat("Depth",&depth,-20.0f,-2.0f);
    //     SetCursorPos(ImVec2(25,380));
    ...
    //     //SKALA
    //     middletext("Skala");
    //     SetCursorPos(ImVec2(40,470));
    //     RadioButton("Perbesar / Perkecil",&scaleType,0);
    //     SetCursorPos(ImVec2(210,470));
    //     RadioButton("Bebas",&scaleType,1);
    //     if(scaleType==0){
    //         SetCursorPos(ImVec2(40,500));
    //         SliderFloat("Skala",&scaleX,0.01f,7.0f);
    //         SetCursorPos(ImVec2(25,530));
    ...
    //         SetCursorPos(ImVec2(40,530));
    //         SliderFloat("Skala Y",&scaleY,0.01f,7.0f);
    //         SetCursorPos(ImVec2(40,560));
    //         SliderFloat("Skala Z",&scaleZ,0.01f,7.0f);
    //         SetCursorPos(ImVec2(25,590));
    //         if (Button("Reset Skala",ImVec2(300,30)))
    //         {
    //             scaleX=1.0f;
    //             scaleY=1.0f;
    ...
    //             drawList->AddLine(drawnPoints[i - 1],drawnPoints[i],IM_COL32((int)(defaultObjColor.x * 255),(int)(defaultObjColor.y * 255),(int)(defaultObjColor.z * 255),(int)(defaultObjColor.w * 255)),lineThickness);
    //         }
    //         SetCursorPosX(25);
